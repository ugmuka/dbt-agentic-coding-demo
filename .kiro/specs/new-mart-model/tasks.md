...
- [ ] 1. orders mart モデルの実装
- [ ] 1.1 (P) 注文ごとのアイテム集計・原価・カテゴリフラグ・顧客内注文順序を含む orders SQL を作成する
...
- [ ] 1.2 (P) orders モデルの YAML スキーマ定義とデータテストを作成する
...
- [ ] 2. customers mart モデルの実装
- [ ] 2.1 (P) 顧客ごとの購買履歴集約と顧客タイプ判定を含む customers SQL を作成する
